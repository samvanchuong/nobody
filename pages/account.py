...
def render_account(username: str) -> None:
    ...
    with tab_password:
        ...
        if st.button("Change password", key="account_update_password"):
    ...
    with tab_face:
        if has_face_registration:
            ...
            if st.button("Remove face registration", key="account_cancel_face_registration"):
                face_dir = dirs["face"]
    ...
    with tab_email:
        ...
        if st.button("Change email", key="account_update_email"):
